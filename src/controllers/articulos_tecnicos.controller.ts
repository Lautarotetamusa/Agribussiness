...
const create = async (req: Request, res: Response): Promise<Response> => {
    ...
    broadcastNotification(notifications['articulo_tecnico:new'](articuloTecnico.titulo))
...
const update = async (req: Request, res: Response): Promise<Response> => {
    ...
    broadcastNotification(notifications['articulo_tecnico:update'](articuloTecnico.titulo));
